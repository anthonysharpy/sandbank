...
static class Config
{
	...
	/// </summary>
	public static readonly float PERSIST_EVERY_N_SECONDS = 10;
	/// <summary>
	...
	/// </summary>
	public static readonly int PARTIAL_WRITES_PER_SECOND = 4;
	/// <summary>
	/// Enables logging for helping to diagnose issues.
	/// </summary>
	public static readonly bool ENABLE_LOGGING = false;
	/// <summary>
