...
Sandbank is designed to be thread-safe, letting you squeeze more out of it. Since it resides in memory, for most use-cases it is probably faster than a conventional database, unless you have hundreds of thousands of records, and you know how to index them efficiently.
